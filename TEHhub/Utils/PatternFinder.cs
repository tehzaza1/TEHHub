...
namespace TEHhub.Utils
{
    ...
    internal static class PatternFinder
    {
        ...
        ///     All patterns are read from the TEHhub.Offsets library so that users just have to update
        ///     TEHhub.Offsets lib once there is a new patch.
        /// </summary>
        private static Pattern[] Patterns => StaticOffsetsPatterns.Patterns;

        /// <summary>
        ///     Tries to find all the patterns given in the TEHhub.Offsets StaticOffsetsPatterns class.
        /// </summary>
