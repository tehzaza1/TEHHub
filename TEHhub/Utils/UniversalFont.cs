...
namespace TEHhub.Utils
{
    ...
    ///       2. the configured GH font (<see cref="TEHhub.Settings.State.FontPathName"/>) — keeps
    ...
    ///
    ///     Gated by <see cref="TEHhub.Settings.State.UniversalFont"/>; when off, the normal
    ...
    internal static class UniversalFont
    {
        ...
        /// <summary>
        ///     Loads the universal font when <see cref="TEHhub.Settings.State.UniversalFont"/> is
