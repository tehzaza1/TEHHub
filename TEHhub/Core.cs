...
namespace TEHhub
{
    ...
    {
        /// <summary>
        ///     Gets the TEHhub version.
        /// </summary>
        private static string version = null!;

        /// <summary>
        ///     Gets the TEHhub Overlay.
        /// </summary>
        public static TEHhubOverlay Overlay { get; internal set; } = null!;
        ...
        /// <summary>
        ///     Gets a value indicating whether the TEHhub settings window is currently open.
        /// </summary>
        ...
        public static void Initialize()
        {
            ...
            {
                Console.WriteLine($"Failed to read TEHhub version: {ex.Message}.");
                version = "Dev";
            }
        }
        ...
        ///     Get TEHhub version.
        /// </summary>
        /// <returns>TEHhub version.</returns>
