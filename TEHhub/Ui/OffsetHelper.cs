...
namespace TEHhub.Ui
{
    ...
    public static class OffsetHelper
    {
        ...
        /// memory from their own thread, so this keeps the normal TEHhub update ordering intact.
        /// </summary>
        ...
        // signature/field validation automatic for normal TEHhub launches.
        ...
        private static void DrawStaticAddresses()
        {
            ...
            ImGui.TextDisabled("Resolved once per attach from TEHhub.Offsets/StaticOffsetsPatterns.cs. \"Self-test\" re-scans them.");
        ...
        private static void DrawCardBody(Entity e)
        {
            ...
            foreach (var kv in components)
            {
                ...
                var root = Eng.VerifyRoot(mapped ? structType! : typeof(TEHhub.Offsets.Objects.Components.ComponentHeader),
        ...
        /// <summary>
        ///     True when an unmapped component's <see cref="TEHhub.Offsets.Objects.Components.ComponentHeader" />
        ...
        {
            var r = Eng.VerifyRoot(typeof(TEHhub.Offsets.Objects.Components.ComponentHeader), "hdr", componentAddr, e.Address, "EntityPtr");
        ...
        private static void SafeSweep()
        {
            try
            {
                var hints = new OffsetRecoveryHints
                {
