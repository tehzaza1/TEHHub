    ...
    public static class OffsetHelperV2
    {
        ...
        private static IEnumerator<Wait> OffsetHelperV2CoRoutine()
        {
            ...
            while (true)
            {
                ...
                // Transition evidence is much cheaper than a full diagnostic sweep and is
                // sampled at ~10 Hz while the OH2 window is open so short loading states
                // are not lost between the 1-second full-diagnostic refreshes.
