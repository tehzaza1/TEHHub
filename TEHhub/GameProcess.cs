...
namespace TEHhub
{
    ...
    public partial class GameProcess
    {
        ...
        ///     based on the TEHhub.Offsets.StaticOffsets file.
        /// </summary>
        ...
        internal void Close(bool monitorForNewGame = true)
        {
            ...
            CoroutineHandler.RaiseEvent(TEHhubEvents.OnClose);
        ...
        ///     based on the TEHhub.Offsets.GameProcessName class.
        /// </summary>
        /// <returns>
        ///     co-routine IWait.
        /// </returns>
        ...
        ///     TEHhub.Offsets.StaticOffsetsPatterns file.
        /// </summary>
        /// <returns>co-routine IWait.</returns>
        private IEnumerator<Wait> FindStaticAddresses()
        {
            while (true)
            {
                yield return new Wait(TEHhubEvents.OnOpened);
        ...
        private bool Open()
        {
            ...
            CoroutineHandler.RaiseEvent(TEHhubEvents.OnOpened);
            return true;
        }
        ...
        private void UpdateIsForeground()
        {
            ...
            if (foreground != this.Foreground)
            {
                ...
                CoroutineHandler.RaiseEvent(TEHhubEvents.OnForegroundChanged);
            }
        }
