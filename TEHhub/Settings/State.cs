...
namespace TEHhub.Settings
{
    ...
    public class State : IJsonOnDeserialized
    {
        ...
        public List<(string path, int group)> SpecialMiscObjPaths = new()
        {
            ...
            ("Metadata/MiscellaneousObjects/Expedition/ExpeditionExplosive", 100),
            ("Metadata/MiscellaneousObjects/Expedition/ExpeditionDynamite", 100),
        ...
        void IJsonOnDeserialized.OnDeserialized()
        {
            ...
            {
                var requiredSpecialPaths = new (string path, int group)[]
                {
                    ("Metadata/MiscellaneousObjects/Expedition/ExpeditionMarker", 100),
                    ("Metadata/MiscellaneousObjects/Expedition/ExpeditionRelic", 101),
                    ("Metadata/MiscellaneousObjects/Expedition/ExpeditionExplosive", 100),
                ...
                foreach (var req in requiredSpecialPaths)
                {
                    if (!SpecialMiscObjPaths.Any(p => string.Equals(p.path, req.path, StringComparison.OrdinalIgnoreCase)))
                    {
                        SpecialMiscObjPaths.Add(req);
                    }
                }
