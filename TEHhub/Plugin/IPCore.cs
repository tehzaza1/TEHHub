...
namespace TEHhub.Plugin
{
    ...
    internal interface IPCore
    {
        ...
        /// <summary>
        ///     Called when the plugin is enabled by the user or when TEHhubOverlay
        ...
        /// <summary>
        ///     Called to draw the plugin settings on the TEHhub Settings window.
        ...
        ///     HUD primitives should use ImGui.GetBackgroundDrawList so TEHhub management
