...
namespace TEHhub.Plugin
{
    ...
    /// <summary>
    ///     Resolves internal TEHhub UI types for plugins loaded from a separate assembly.
    /// </summary>
    public static class PluginUiElementReflection
    {
        private static readonly Assembly TEHhubAssembly = typeof(Core).Assembly;

        public static Type? UiElementParentsType { get; } =
            TEHhubAssembly.GetType("TEHhub.Cache.UiElementParents");

        public static Type? UiElementBaseType { get; } =
            TEHhubAssembly.GetType("TEHhub.RemoteObjects.UiElement.UiElementBase");
