...
namespace TEHhub.Cache
{
    ...
    ///     are outside the network bubble, TEHhub will never know to clean them up.
    ///
    ...
    ///     disappears (even if they are not in the network bubble). However, TEHhub still show them
    ...
    public class DisappearingEntity
    {
        ...
        ///     Reference to the structure storing all the entities known to TEHhub.
        /// </param>
