...
namespace Launcher
{
    ...
    /// <summary>
    /// Detects the x64 .NET runtime required by the framework-dependent GameHelper executable.
    ...
    internal static class DotNetRuntimeDetector
    {
        ...
        internal static void ShowInstallPrompt()
        {
            ...
            Console.WriteLine("Microsoft .NET 10 Runtime for Windows x64 is required to run GameHelper.");
