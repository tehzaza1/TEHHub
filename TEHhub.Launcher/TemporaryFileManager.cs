...
namespace TEHhub.Launcher
{
    ...
    /// <summary>
    ///     A helper class to manage the temporary executables created by the <see cref="TEHhub.Launcher"/>.
    /// </summary>
    public static class TemporaryFileManager
    {
        ...
        ///     This includes the files added in the previous executions of <see cref="TEHhub.Launcher"/>.
        /// </summary>
