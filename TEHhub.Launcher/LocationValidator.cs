...
namespace TEHhub.Launcher
{
    ...
    public static class LocationValidator
    {
        ...
        /// <summary>
        ///     Checks the TEHhub tool path name to make sure it doesn't have any bad information.
        ///     If it does, print the issue to the stdout.
        /// </summary>
        /// <returns>returns true in case of good path otherwise false.</returns>
        public static bool IsTEHhubLocationGood(out string? message)
        {
            message = null;
            ...
            {
                message = $"You have downloaded TEHhub in a bad folder/pathname. " +
                    $"Your folder/pathname contains \"{pathMatch.Value}\". " +
                    $"This is bad for your account. Please rename/move TEHhub to a better folder/pathname.";
                return false;
            }
