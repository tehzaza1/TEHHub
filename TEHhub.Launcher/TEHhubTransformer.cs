// <copyright file="TEHhubTransformer.cs" company="None">
...
namespace TEHhub.Launcher
{
    ...
    /// <summary>
    ///     A helper class to transform the TEHhub tool name and metadata info.
    /// </summary>
    public static class TEHhubTransformer
    {
        /// <summary>
        ///     Transforms the TEHhub tool name and metadata info.
        /// </summary>
        /// <param name="newName">string to replace the name and metadata info with.</param>
        /// <returns></returns>
        public static string TransformTEHhubExecutable(string gameHelperDir, string gameHelperLoc, string newName)
        {
