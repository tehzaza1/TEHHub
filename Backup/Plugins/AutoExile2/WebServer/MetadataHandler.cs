        ...
        public static object GetMetadata(IEnumerable<IBotMode>? registeredModes = null)
        {
            ...
            return new
            {
                ...
                roles = new object[]
                {
                    ...
                    new { id = SkillRole.TotemOrMinion.ToString(), label = "Totem / Minion Deploy", desc = "Deploy totem or minion toward enemies" },
                ...
                categoryPresets = new Dictionary<string, object>
                {
                    ...
                    ["Minion"] = new { role = "TotemOrMinion", priority = 5, interval = 6000, hold = 150, filter = "Any", lowHp = false, lowHpThresh = 60, minEnemies = 1, maxRange = 60, maxMinions = 3, label = "🧟 Minion", color = "#06b6d4", bg = "rgba(6,182,212,0.15)" },
